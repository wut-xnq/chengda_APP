<template>
  ...
  ></page-meta>
  <div :class="isH5 ? 'msg-page-wrapper-h5' : 'msg-page-wrapper'" class="chat-box">
    ...
    <div style="height: 'auto'" class="chat-footer">
...
import { ref, onMounted, onUnmounted,nextTick} from '../../utils/transformVue'
...
function pageTo(){
	setTimeout(()=>{
		  nextTick(()=>{
		  	  uni.createSelectorQuery().select('.chat-message')
