...
export default {
  ...
  // 账户与安全
  AccountsSecurity:'账户与安全',
  setPassword:'设置密码',
  loginDevice:'登录设备',
  cancelAccount:'注销账号',
  cancelAccountTitle:'您确定注销账号吗？',
  // 我的订单
  myOrderes:'我的订单',
  // 商品详情页面
  productDetailsPage:'',
  ...
  // 查看物流
  weslogisticsView:'查看物流',
  NeedPhotoPermissionTitle: '需要相册权限',
  NeedPhotoPermissionContent: '为了设置您的头像，我们需要访问设备中的照片。授权后您可在系统设置中随时关闭。',
  Allow: '允许',
  Cancel: '取消',
  SelectAvatarFailed: '未选择有效图片',
  AvatarUpdated: '头像更新成功',
  PhotoPermissionDenied: '未获得相册访问权限'
}
