...
export default {
  ...
  NeedPhotoPermissionContent: 'To set your avatar, we need access to photos on your device. You can disable this in system settings anytime.',
  Allow: 'Allow',
  Cancel: 'Cancel',
  SelectAvatarFailed: 'No valid image selected',
