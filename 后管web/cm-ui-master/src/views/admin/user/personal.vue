<template>
  <el-drawer v-model="visible" :title="$t('personal.name')" size="40%">
    <el-tabs style="height: 200px" class="demo-tabs" type="card">
...
const handleChangePassword = () => {	
  passwordFormdataRef.value.validate((valid: boolean) => {
	...
	passwordFormData.userId = userInfo.sysUser.userId
    password(passwordFormData,userInfo?.roles?.includes('3'))
        .then(() => {
