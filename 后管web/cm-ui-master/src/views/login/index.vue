			...
			<div class="login-box">
				<div class="login-form">
					...
					<el-tabs v-model="tabsActiveName" type="card">
						<!-- 管理端密码登录 -->
						<el-tab-pane :label="$t('login.label.one1')" name="account">
							<Password @signInSuccess="signInSuccess" />
						</el-tab-pane>
						<!-- 商户端密码登录 -->
						<el-tab-pane :label="$t('login.label.four4')" name="account1">
							<Merchant @signInSuccess="signInSuccess" />
						</el-tab-pane>
						<!-- 手机号登录 -->
						<el-tab-pane :label="$t('login.label.two2')" name="mobile" v-if="mobileEnable">
							<Mobile @signInSuccess="signInSuccess" />
						</el-tab-pane>
						<!-- 注册 -->
						<el-tab-pane :label="$t('login.label.register')" name="register" v-if="registerEnable">
...
const Merchant = defineAsyncComponent(() => import('./component/merchant.vue'));
