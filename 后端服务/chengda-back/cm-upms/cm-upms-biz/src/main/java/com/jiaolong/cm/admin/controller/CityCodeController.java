...
import com.jiaolong.cm.admin.api.feign.RemoteCityCodeService;
...
public class CityCodeController {
	...
	@Autowired
	private RemoteCityCodeService remoteCityCodeService;
	...
	public R<List<CityCodeDto>> getAllTree() {
		return remoteCityCodeService.getAllTree();
	}
	...
	public R<List<CityCode>> getChildrenList(@PathVariable("cityPid") Integer cityPid) {
		return remoteCityCodeService.getChildrenList(cityPid);
	}
}
