...
package com.jiaolong.cm.auth.endpoint;
...
import com.jiaolong.cm.admin.api.entity.SysOauthClientDetails;
import com.jiaolong.cm.admin.api.feign.RemoteClientDetailsService;
import com.jiaolong.cm.admin.api.vo.TokenVo;
...
import com.jiaolong.cm.common.core.util.SpringContextHolder;
import com.jiaolong.cm.common.security.annotation.Inner;
import com.jiaolong.cm.common.security.util.OAuth2EndpointUtils;
import com.jiaolong.cm.common.security.util.OAuth2ErrorCodesExpand;
import com.jiaolong.cm.common.security.util.OAuthClientException;
...
public class CmTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new CmAuthenticationFailureEventHandler();
