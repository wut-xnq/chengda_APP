...
package com.jiaolong.cm.common.log.event;
...
import com.jiaolong.cm.common.core.jackson.CmJavaTimeModule;
...
public class SysLogListener implements InitializingBean {
	...
	private final CmLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new CmJavaTimeModule());
	}
