...
public class CmRemoteRegisteredClientRepository implements RegisteredClientRepository {
	...
	/**
	 * 请求令牌有效期 14 天（默认 12 小时）
	 */
	private final static int accessTokenValiditySeconds = 60 * 60 * 24 * 14;
