package com.jiaolong.cm.common.security.util;
...
/**
 * @author laofuzi
 * @description CustomerException 端口登录异常信息
 */
public class CustomerException extends OAuth2AuthenticationException {
