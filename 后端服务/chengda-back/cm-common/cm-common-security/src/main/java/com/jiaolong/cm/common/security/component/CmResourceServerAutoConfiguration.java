...
public class CmResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public CmBearerTokenExtractor cmBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new CmBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new CmCustomOpaqueTokenIntrospector(authorizationService);
	}
