...
public class CmMerchantDetailsServiceImpl implements CmUserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) {
		R<UserInfo> result = remoteCustomerService.customerInfo(username, SecurityConstants.FROM_IN);
	...
	public boolean support(String clientId, String grantType) {
		return SecurityConstants.MERCHANT.equals(clientId);
	}
