...
package com.jiaolong.cm.common.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class CmSentinelFeign {

	private CmSentinelFeign() {

	}

	public static CmSentinelFeign.Builder builder() {
		return new CmSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public CmSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new CmSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new CmSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new CmSentinelInvocationHandler(target, dispatch);
				}
